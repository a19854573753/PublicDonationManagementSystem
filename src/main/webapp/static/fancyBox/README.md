...
More information and examples: www.fancyapps.com/fancybox/
...
Note, ajax requests are subject to the [same origin policy](en.wikipedia.org/wiki/Same_origin_policy).
